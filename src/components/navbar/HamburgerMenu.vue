...
<template>
  <div>
    ...
    >
      <div class="flex flex-col items-end w-screen h-screen gap-5 p-5">
        <button type="button" @click="toggleMenu">
          <X color="white" :size="32" class="z-20" />
        </button>
        <div class="flex flex-col items-center justify-center flex-1 w-full pb-16 gap-14">
          <slot />
          <ul
            class="flex flex-col items-center justify-center gap-5 text-2xl font-normal text-zinc-50"
          >
